                            ...
                            rp(url)
                                .then(async function(html) {
                                    ...
                                    async function sendMsg(l = null, rpl = null) {
                                        ...
                                        if (itemClass && itemClassImg) originalEmbed.setFooter( {text: itemClass, iconURL: itemClassImg} )
                                    ...
                                    async function descriptionCollected(i, reply, pageNo = 1) {
                                        ...
                                        if (itemClass && itemClassImg) embed.setFooter({text: itemClass, iconURL: itemClassImg})
